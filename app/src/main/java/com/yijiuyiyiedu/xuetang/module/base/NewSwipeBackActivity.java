...
/**
 */
public abstract class NewSwipeBackActivity  extends AppCompatActivity implements BGASwipeBackHelper.Delegate {
...
//        View viewById = findViewById(R.id.settings_statusBar);
