 ...
 *
 * Created by xuenhao on 2018/5/31.
 *
 */
public class MyClearEditText extends EditText implements TextWatcher {
    ...
    private void initClearDrawable() {
        ...
        // 判断清除的图片是否为空
        if (draw == null) {
            draw = getResources().getDrawable(R.mipmap.text_clear);
            draw.setBounds(0, 0, 25, 25);
        }
//        draw.setBounds(0, 0, draw.getIntrinsicWidth(), draw.getIntrinsicHeight());
    ...
    public void onTextChanged(CharSequence text, int start, int lengthBefore,
        ...
        // 判断输入框中是否有内容
        if (text.length() > 0) {
//            draw.setBounds(0, 0, UtilDpOrPx.dip2px(getContext(),20),  UtilDpOrPx.dip2px(getContext(),20));
            this.setCompoundDrawablesWithIntrinsicBounds(null, null, draw, null);
        } else {
            this.setCompoundDrawablesWithIntrinsicBounds(null, null, null, null);
        }
