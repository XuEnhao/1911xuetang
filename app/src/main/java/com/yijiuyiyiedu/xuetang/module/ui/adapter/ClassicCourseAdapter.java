...
public class ClassicCourseAdapter extends BaseQuickAdapter<ClassicCourseEntity.DataBean.CurriculumListBean, BaseViewHolder> {
    public ClassicCourseAdapter(int layoutResId, @Nullable List<ClassicCourseEntity.DataBean.CurriculumListBean> data) {
        super(layoutResId, data);
    }

    @Override
    protected void convert(BaseViewHolder helper, ClassicCourseEntity.DataBean.CurriculumListBean item) {
