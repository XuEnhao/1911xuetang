...
import com.yijiuyiyiedu.xuetang.module.entity.Prodata;
import com.yijiuyiyiedu.xuetang.module.ui.activitys.CourseDetailsActivity;
import com.yijiuyiyiedu.xuetang.module.ui.adapter.RecycleItemClickListener;
    ...
    private void initData() {
        ...
        RecycleItemClickListener clickListener = new RecycleItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                JumpUtil.jump(getContext(), CourseDetailsActivity.class);
            }
        };
