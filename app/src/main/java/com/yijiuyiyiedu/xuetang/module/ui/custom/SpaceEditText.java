...
import com.yijiuyiyiedu.xuetang.utils.AppUtils;
import com.yijiuyiyiedu.xuetang.utils.EditTextUtils;
    ...
    private void initView(Context context) {
        addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                LogUtil.LogD("mengyuan", "onTextChanged：s:" + s);
                LogUtil.LogD("mengyuan", "onTextChanged：start:" + start);
                LogUtil.LogD("mengyuan", "onTextChanged：before:" + before);
                LogUtil.LogD("mengyuan", "onTextChanged：count:" + count);
                LogUtil.LogD("mengyuan", "onTextChanged：getSelectionStart:" + SpaceEditText.this.getSelectionStart());
                LogUtil.LogD("mengyuan", "onTextChanged：getSelectionEnd:" + SpaceEditText.this.getSelectionEnd());
